    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" x-data="{ mobileMenuOpen: false }">
        ...
        <nav class="hidden items-center justify-between lg:flex">
            <div class="flex items-center gap-6">
                ...
                <a href="{{ route('dashboard') }}" class="flex items-center gap-3">
                    <x-application-logo class="h-12 w-12 rounded-md" />
                    <span class="leading-tight">
                        <span class="block text-lg font-semibold tracking-wide text-foreground">CHEMSA</span>
                        <span class="block text-xs font-semibold text-red-600">Cherif Multi-Services Automobile</span>
                    </span>
                </a>
        ...
        <div class="block lg:hidden">
            <div class="flex items-center justify-between">
                <!-- Logo -->
                <a href="{{ route('dashboard') }}" class="flex items-center gap-3">
                    <x-application-logo class="h-11 w-11 rounded-md" />
                    <span class="leading-tight">
                        <span class="block text-base font-semibold tracking-wide text-foreground">CHEMSA</span>
                        <span class="block text-[11px] font-semibold text-red-600">Cherif Multi-Services Automobile</span>
                    </span>
                </a>
