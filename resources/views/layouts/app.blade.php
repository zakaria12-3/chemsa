...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased bg-background text-foreground">
        ...
        <script>
            ...
            window.currencySymbol = "{{ \App\Models\Setting::get('currency_symbol', 'TND') }}";
            window.currencyPosition = "{{ \App\Models\Setting::get('currency_position', 'right') }}";
            window.currencyFraction = parseInt("{{ \App\Models\Setting::get('currency_fraction_digits', 3) }}");
