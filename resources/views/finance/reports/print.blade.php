...
<head>
    <meta charset="UTF-8">
    <title>Laporan Arus Kas - CHEMSA</title>
    <style>
        ...
        .header-container { border-bottom: 2px solid #444; padding-bottom: 20px; margin-bottom: 30px; display: flex; justify-content: space-between; align-items: flex-start; gap: 20px; }
        ...
        .company-tagline { margin: 0 0 4px 0; font-size: 12px; font-weight: bold; color: #c62828; }
        ...
        @media print {
            ...
            * { -webkit-print-color-adjust: exact; print-color-adjust: exact; background: transparent !important; box-shadow: none !important; text-shadow: none !important; }
            ...
            .company-tagline { color: #c62828 !important; }
...
<body>
    ...
    <div class="header-container">
        <div class="company-brand">
            <img class="company-logo" src="{{ asset('images/chemsa-logo.jpg') }}" alt="CHEMSA logo">
            <div class="company-info">
                <h1>CHEMSA</h1>
                <div class="company-tagline">Cherif Multi-Services Automobile</div>
                @if($storeAddress && $storeAddress !== 'Cherif Multi-Services Automobile')
                    <p>{{ $storeAddress }}</p>
                @endif
                @if($storePhone !== '-')
                    <p>Telp: {{ $storePhone }}</p>
