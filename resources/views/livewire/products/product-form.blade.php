    ...
    <div class="p-6">
        ...
        <form wire:submit="save" class="space-y-6">
            ...
            <div class="flex flex-col sm:flex-row gap-6">
                <!-- Purchase Price -->
                <div class="w-full sm:w-1/2 space-y-2">
                    <x-input-label for="purchase_price" :value="__('Purchase Price') . ' (' . \App\Models\Setting::get('currency_symbol', 'TND') . ')'" />
                    <x-currency-input
                        id="purchase_price"
                ...
                <!-- Selling Price -->
                <div class="w-full sm:w-1/2 space-y-2">
                    <x-input-label for="selling_price" :value="__('Selling Price') . ' (' . \App\Models\Setting::get('currency_symbol', 'TND') . ')'" />
                    <x-currency-input
                        id="selling_price"
